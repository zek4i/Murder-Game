...
{
    [SerializeField] public float lookSensitivity = 1f; // Horizontal sensitivity (left/right look)
    [SerializeField] public float pivotSensitivity = 1f; // Vertical sensitivity (up/down look)
    ...
    private void RotateCamera()
    {
        ...
        pivotAngle = pivotAngle - (inputManager.cameraInputY * cameraPivotSpeed * pivotSensitivity);

        // Clamp the pivot angle to prevent the camera from flipping upside down
